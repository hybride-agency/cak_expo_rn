      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.dateRow}>
            ...
            {fitnessPlan?.has_video_access &&
            !fitnessPlan.requires_quiz_completion ? (
...
const WorkoutSectionCard = ({
  ...
  const exerciseCount =
    section.exercise_count ?? section.exercises?.length ?? 0;
    ...
    >
      <View style={styles.groupCopy}>
        ...
        <Text style={styles.groupDescription}>
          {day?.summary ||
            `${exerciseCount} exercises · ${completedCount} completed`}
        </Text>
